...
class Client(object):
    ...
    def mms_create(
        self, originator, recipients, body, mediaUrls, subject=None, reference=None, scheduledDatetime=None
    ):
        """Send bulk mms.
    ...
    def verify_create_email(self, recipient, originator, params=None):
        ...
        if params is None:
            params = {}
        params.update({"type": "email", "recipient": recipient, "originator": originator})
        return Verify().load(self.request("verify", "POST", params))
